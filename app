...
function saveSku(sku){if(!sku)return;var skus=getKnownSkus();if(!skus.includes(sku)){skus.unshift(sku);if(skus.length>200)skus=skus.slice(0,200);store.setItem('ops_skus',JSON.stringify(skus));}}
