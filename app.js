...
function renderDash(){
  ...
  // Don't rebuild if user is actively typing in the inline rows
  var _ae=document.activeElement;
  var _inRows=_ae&&_ae.closest&&_ae.closest('#lines-list');
  if(_inRows) return; // Skip full re-render while user is typing
