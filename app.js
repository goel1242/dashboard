...
function palletField(el){
  ...
  if(field==='shipType'){
    ...
    // Update only the color dot and max height display - no full re-render
...
function genShiftSummary(){
  ...
  lines2.push('משטחים: נפתחו '+(closedPallets+openPallets)+' | נסגרו '+closedPallets+' | פתוחים '+openPallets);
