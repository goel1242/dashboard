...
function renderLineRows(){
  ...
  filtered.forEach(function(r){
    ...
    if(isDone||isPartial){
      ...
      html+='<button data-lid="'+currentLine+'" data-idx="'+realIdx+'" onclick="toggleLtPartial(this)" style="width:34px;height:34px;background:#F5C4B3;color:#993C1D;border:0.5px solid #F0997B;border-radius:8px;font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center">~</button>';
