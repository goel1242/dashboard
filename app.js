...
function renderDash(){
  ...
  calcs.map(function(c){
    ...
    return '<div data-cid="'+c.id+'" style="background:var(--card);border:1px solid var(--border);border-radius:12px;padding:10px 8px;cursor:pointer;text-align:center" onclick="openLineDetail(this.getAttribute(\"data-cid\"))">'+
