...
function renderRedRowsManager(){
  ...
  Object.values(byLine).forEach(function(group){
    html+='<div style="margin-bottom:10px"><div style="font-size:13px;font-weight:700;padding:6px 10px;background:var(--red-bg);border-radius:8px;margin-bottom:4px">'+group.line.name+' — '+group.rows.length+' שורות</div>';
    group.rows.forEach(function(item){
      var r=item.row;
      html+='<div style="padding:8px 12px;background:var(--card);border:1px solid var(--border);border-radius:8px;margin-bottom:4px">';
