...
function loadWorkOrdersFile(event){
  ...
  reader.onload=function(e){
    try{
      var parsed=parseWorkOrdersHTML(e.target.result);
      var total=Object.keys(parsed).length;
      if(!total){showT('\u05dc\u05d0 \u05e0\u05de\u05e6\u05d0\u05d5 \u05e4\u05e7"\u05e2\u05d5\u05ea \u05d1\u05e7\u05d5\u05d1\u05e5','r');return;}
      var res=matchWorkOrdersToRows(parsed);
      saveWorkOrders();
      showT('\u05e0\u05e7\u05dc\u05d8\u05d5 '+res.matched+' \u05de\u05ea\u05d5\u05da '+total+' \u05e4\u05e7"\u05e2\u05d5\u05ea');
      if(res.unmatched.length){
        pushAlert('y','\u05dc\u05d0 \u05e0\u05de\u05e6\u05d0\u05d4 \u05d4\u05ea\u05d0\u05de\u05d4 \u05dc-'+res.unmatched.length+' \u05e4\u05e7"\u05e2\u05d5\u05ea: '+res.unmatched.slice(0,5).join(', ')+(res.unmatched.length>5?' \u05d5\u05e2\u05d5\u05d3...':''));
      }
      var statusEl=document.getElementById('wo-upload-status');
      if(statusEl){
        statusEl.innerHTML='<div style="color:var(--green);font-weight:700">\u2713 '+res.matched+'/'+total+' \u05e0\u05e7\u05dc\u05d8\u05d5 \u05d5\u05e9\u05d5\u05d9\u05db\u05d5</div>'+
          (res.unmatched.length?'<div style="color:var(--yellow);margin-top:6px;font-size:11px">\u05dc\u05dc\u05d0 \u05d4\u05ea\u05d0\u05de\u05d4: '+res.unmatched.join(', ')+'</div>':'');
      }
      renderDash();
    }catch(err){
      console.error('Work order parse error:',err);
      showT('\u05e9\u05d2\u05d9\u05d0\u05d4 \u05d1\u05e7\u05e8\u05d9\u05d0\u05ea \u05d4\u05e7\u05d5\u05d1\u05e5','r');
    }
  };
