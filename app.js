...
function loadState(){
  ...
  var today=new Date().toDateString();
  var saved=store.getItem('ops_date');
  if(saved && saved!==today){closeOpenStoppagesForDayEnd();saveToHist(saved);clearDay();clearServerDay();return;}
  try{
...
function syncFromServer(){
  if(isNewDay()){var saved=store.getItem('ops_date');cleanupCompletedWorkOrders();closeOpenStoppagesForDayEnd();saveToHist(saved);clearDay();clearServerDay();renderDash();return;}
