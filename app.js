...
function renderLineRows(){
  ...
  sorted.forEach(function(r){
    ...
    if(r.customer) html += '<div style="font-size:11px;font-weight:600;color:var(--text)">'+r.customer+'</div>';
    html += '</div></div>';
    ...
    if(r.desc) html += '<span style="font-size:11px;color:var(--dim)">'+r.desc+'</span>';
    ...
    if(!isDone){
      ...
      html += '<button data-lid="'+currentLine+'" data-idx="'+realIdx+'" onclick="markRowDone(this.dataset.lid,parseInt(this.dataset.idx));renderLineRows()" style="flex:1;padding:7px;background:var(--green);border:none;border-radius:7px;color:#fff;font-size:13px;font-weight:700;cursor:pointer">&#10003; הושלם</button>';
      html += '<button data-lid="'+currentLine+'" data-idx="'+realIdx+'" onclick="toggleLtPartial(this)" style="padding:7px 12px;background:var(--yellow-bg);border:1px solid rgba(217,119,6,.3);border-radius:7px;color:var(--yellow);font-size:12px;font-weight:700;cursor:pointer">חלקי</button>';
      html += '</div>';
