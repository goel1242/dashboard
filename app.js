...
function renderHistory(){
  ...
  var history={}; try{history=JSON.parse(store.getItem('ops_history')||'{}');}catch(e){}
  ...
  var filtered=keys.filter(function(k){
    var _kd=new Date(k+'T12:00:00'); // noon to avoid timezone shift
    return (now-_kd)<=(histTab==='week'?7:31)*24*3600*1000;
  });
