...
function syncToServer(){
  ...
  sbFetch('ops_data',{method:'POST',prefer:'resolution=merge-duplicates',body:JSON.stringify(rows)})
    .then(function(){
      ...
      // Sync order_rows separately (can be large)
      var orRows=[{key:'order_rows',value:JSON.stringify(orderRows),updated_at:new Date().toISOString()}];
      sbFetch('ops_data',{method:'POST',prefer:'resolution=merge-duplicates',body:JSON.stringify(orRows)}).catch(function(){});
    })
