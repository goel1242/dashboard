...
function addPallet(){
  window._lastUserAction=Date.now();
  var id='P'+Date.now();
  pallets.unshift({id:id,orderId:'',customer:'',pkNum:'',shipType:'sea',maxHeight:220,special:false,specialNote:'',cartons:{dolbox:0,upgrade:0,box2x2:0},sourceLogs:[],closed:false,createdAt:nowTime(),updatedAt:Date.now()});
        ...
        rows.forEach(function(row){
          ...
          if(existing){
            ...
            pallets.unshift({
              ...
              shipType:'sea',maxHeight:220,special:false,specialNote:'',
              cartons:{dolbox:0,upgrade:0,box2x2:0},sourceLogs:[],
              closed:false,createdAt:nowTime(),
