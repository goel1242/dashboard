...
function syncFromServer(){
  ...
  sbFetch('ops_data?select=key,value').then(function(rows){
    ...
    if(document.getElementById('page-pack').classList.contains('active')){
      buildRequestForms();
      // Only re-render pallets if user is not typing in a pallet field
      var activeEl=document.activeElement;
      var isTypingInPallet=activeEl&&(activeEl.id.startsWith('p')||activeEl.getAttribute('data-pid'));
      if(!isTypingInPallet) renderPallets();
      renderPackRequests();
    }
