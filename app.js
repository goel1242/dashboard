...
function renderSetupRequests(){
  ...
  if(!relevantStops.length&&!open.length){
    html+='<div class="empty">\u05d0\u05d9\u05df \u05d1\u05e7\u05e9\u05d5\u05ea \u05d0\u05d5 \u05e2\u05e6\u05d9\u05e8\u05d5\u05ea \u05e4\u05ea\u05d5\u05d7\u05d5\u05ea \u05db\u05e8\u05d2\u05e2</div>';
  }
  if(handled.length){
...
function addManualRow(){
  ...
  var customer=document.getElementById('mr-customer').value.trim();
  ...
  orderRows[lineId].push({
    ...
    note:'',order:order,orderLine:orderLine,customer:customer,
  ...
  updateDashKPIs();
  showT('שורה נוספה!');
  ['mr-order','mr-orderline','mr-sku','mr-desc','mr-customer','mr-qty','mr-startdate'].forEach(function(id){
