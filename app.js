...
var targets={},reports={},reportsUpdatedAt={},orderRowsLastTotal={},redRows={},redClosed={},stoppages=[],alertsLog=[],history={},dayResetMarker=0,planItemStatus={};
...
function clearDay(){
  ...
  targets={};reports={};reportsUpdatedAt={};orderRowsLastTotal={};planItemStatus={};redRows={};redClosed={};stoppages=[];palletRequests=[];orderRows={};
...
function applyRemoteResetIfNewer(remoteMarkerStr){
  ...
  if(remoteMarker>dayResetMarker){
    targets={};reports={};reportsUpdatedAt={};orderRowsLastTotal={};planItemStatus={};redRows={};redClosed={};stoppages=[];orderRows={};
    store.removeItem('ops_order_rows');
...
function renderSetupScreen(){
  ...
  var tabsHtml='<div style="display:flex;gap:6px;margin-bottom:14px">'+
    '<button onclick="toggleSetupSubTab(\'requests\')" style="flex:1;padding:9px;border-radius:8px;border:1px solid var(--border);font-size:12px;font-weight:700;cursor:pointer;'+
    ...
    '<button onclick="toggleSetupSubTab(\'plan\')" style="flex:1;padding:9px;border-radius:8px;border:1px solid var(--border);font-size:12px;font-weight:700;cursor:pointer;'+
...
function fetchMaterialsNow(){
  sbFetch('ops_data?select=key,value&key=in.(materials,plan_status)').then(function(rows){
    var map={};(rows||[]).forEach(function(r){map[r.key]=r.value;});
    var changed=false;
